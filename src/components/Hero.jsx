  ...
  return (
    <section className="relative min-h-screen flex flex-col-reverse md:flex-row  items-center justify-center md:justify-between px-6 md:px-20 lg:px-32 bg-slate-950 text-white overflow-hidden">
      ...
      >
        ...
        >
Passionate about building efficient, scalable, and user-friendly web applications using Python, Django, and JavaScript. Currently creating real-world projects and exploring Machine Learning and AI to enhance digital solutions.
        </motion.p>
        ...
        >
          <motion.a
            ...
            href="https://github.com/SujanPakhrin01"
            target="_blank"
          ...
          <motion.a
            whileHover={{ y: -5, scale: 1.1 }}
            href="https://www.linkedin.com/in/sujanmakalu/"
            target="_blank"
            className="p-3 rounded-full bg-slate-800 hover:bg-indigo-600 transition-all duration-300 ease-in-out transform-gpu"
            aria-label="LinkedIn"
          >
          ...
          <motion.a
            whileHover={{ y: -5, scale: 1.1 }}
            href="https://x.com/SujanPakhrin01"
            target="_blank"
            className="p-3 rounded-full bg-slate-800 hover:bg-indigo-600 transition-all duration-300 ease-in-out transform-gpu"
            aria-label="Twitter"
          >
            ...
            <motion.a
            whileHover={{ y: -5, scale: 1.1 }}
            href="https://www.instagram.com/sujanpakhrin01/"
            target="_blank"
            className="p-3 rounded-full bg-slate-800 hover:bg-indigo-600 transition-all duration-300 ease-in-out transform-gpu"
      ...
      >
        ...
        >
          <span className="text-white roboto-slab font-bold">Django</span>
        </motion.div>
        <motion.div
          animate={{ y: [0, 15, 0], rotate: [0, -10, 0] }}
          transition={{
