...
const Projects = () => {
  ...
  const projects = [
    {
  id: 1,
  title: "NFS Stock Data Analytics",
  description:
    "Opening and analyzing NFS stock data using Python with NumPy, Pandas, Matplotlib, and Seaborn.",
  features: [
    "NFS stock data loading and preprocessing",
    "Statistical analysis with NumPy and Pandas",
    "Data visualization with Matplotlib",
    "Advanced plots and insights with Seaborn",
  ],
  technologies: ["Python", "NumPy", "Pandas", "Matplotlib", "Seaborn"],
  stack: ["Data Analytics", "Data Visualization", "Python"],
  icons: [SiPython, SiNumpy, SiPandas, SiPlotly], // replace with actual icons you have
  githubUrl: "https://github.com/SujanPakhrin01/NFS-STOCK-DATA",
  liveUrl: "https://github.com/SujanPakhrin01/NFS-STOCK-DATA", // no live URL provided
  image: stock, // update if needed
  color: "#06B6D4",
  type: "Data Analytics",
},

{
  ...
  description:
    "This app lets you add, edit, delete, and mark tasks as done. Built with a frontend, backend, and database, it demonstrates basic full-stack web development.",
  features: [
  ...
  technologies: ["Django", "Django REST Framework", "Python", "React", "JavaScript"],
  stack: ["Frontend", "Backend", "Database"],
  icons: [SiDjango, SiPython, FaReact, FaJsSquare], // adjust to your imports
  githubUrl: "https://github.com/SujanPakhrin01/ToDo-Full-stack",
  liveUrl: "https://github.com/SujanPakhrin01/ToDo-Full-stack",
  image: todo, // add screenshot if available
  color: "#10B981",
  type: "Full-Stack",
},
{
  id: 3,
  title: "RealTime Eye Detection",
  description:
    "A simple Python project that detects faces and eyes in real-time using OpenCV and Haar Cascade.",
  features: [
    "Real-time face detection via webcam",
    "Eye detection using Haar Cascade classifiers",
    "Live bounding box rendering with OpenCV",
    "Lightweight and dependency-minimal setup",
  ],
  technologies: ["Python", "OpenCV"],
  stack: ["Computer Vision", "Python"],
  icons: [SiPython, SiOpencv], // adjust to your imports
  githubUrl: "https://github.com/SujanPakhrin01/RealTime-Eye-Detection",
  liveUrl:"https://github.com/SujanPakhrin01/RealTime-Eye-Detection",
  image: eye,
  color: "#F59E0B",
...
{
  id: 4,
  title: "Note Full-Stack",
  description:
    "Full-stack project built with Django handling backend operations and HTML used for frontend.",
  features: [
    "Create, read, update, and delete notes",
    "Django-powered backend with ORM",
    "Responsive UI with Bootstrap",
    "Clean and minimal note management interface",
  ],
  technologies: ["Django", "Python", "HTML", "CSS", "Bootstrap"],
  stack: ["Frontend", "Backend", "Database"],
  icons: [SiDjango, SiPython, FaHtml5, SiCss3], // adjust to your imports
  githubUrl: "https://github.com/SujanPakhrin01/Note-Full-stack-",
  liveUrl: "https://github.com/SujanPakhrin01/Note-Full-stack-",
  image: Note,
  color: "#8B5CF6",
  type: "Full-Stack",
},
              ...
              {[
                {
                  icon: FaReact,
                  label: "Frontend",
                  desc: "HTML, TailwindCSS,React,",
                },
                {
                  icon:   FaPython,
                  label: "Backend",
                  desc: "Django, DjangoRestFramework, REST APIs",
                },
                {
                  icon: FaServer,
                  label: "Database",
