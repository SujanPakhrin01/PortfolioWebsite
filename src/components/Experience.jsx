  ...
  const experiences = [
    {
      ...
      description:
        "Developed responsive web applications using React.js and Django. Collaborated with UX designers to implement pixel-perfect interfaces.",
      technologies: ["React", "Django","DjangoRestFramework", "Tailwind CSS"],
      achievements: [
    ...
    },
    {
      ...
      technologies: ["React", "Django", "PostgreSQL", "DjangoRestFramework"],
      achievements: [
  ...
  const education = [
    {
      ...
      achievements: ["GPA: 3.6/4.0 First Sem"],
    ...
    },
    {
      ...
      description:
        "NEB",
      achievements : [
        "Awarded Government Scholarship for 11th and 12th grade",
      ],
    },
  ];
