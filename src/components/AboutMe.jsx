    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.p
            className="text-xl md:text-2xl max-w-4xl mx-auto roboto-slab text-slate-300 mb-6"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2, duration: 0.5 }}
          >
          Passionate full-stack developer specializing in React, Django, and Django REST Framework. I focus on building dynamic web applications and APIs, turning ideas into functional, efficient, and scalable digital experiences while continuously exploring new technologies.
          </motion.p>
        </motion.div>
              ...
              >
                ...
                <div className="space-y-5 roboto-slab">
                  <motion.div
                    ...
                    transition={{ delay: 0.2, duration: 0.5 }}
                  >
                 I'm a passionate full-stack developer with expertise in React, Django, and Django REST Framework. With a strong foundation in Python and modern web technologies, I specialize in building efficient, scalable, and user-friendly web applications that solve real-world problems.
                  ...
                  >
     My journey in coding and web development started 1 year ago, and since then I've been learning Python, Django, JavaScript, and web technologies. I enjoy building real-world projects, turning ideas into functional applications, and now exploring Machine Learning and AI to expand my skills.
                  ...
                  >
               When I'm not coding, you can find me trading in the stock market, exploring Django and Machine Learning, or learning new web technologies to level up my skills.
                  </motion.div>
                </div>
              </motion.div>
